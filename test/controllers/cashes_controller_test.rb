...
class CashesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cash" do
    assert_difference('Cash.count') do
      post cashes_url, params: { cash: { count: @cash.count, date: @cash.date, event: @cash.event, inflow: @cash.inflow, name: @cash.name, outflow: @cash.outflow } }
    end
  ...
  test "should update cash" do
    patch cash_url(@cash), params: { cash: { count: @cash.count, date: @cash.date, event: @cash.event, inflow: @cash.inflow, name: @cash.name, outflow: @cash.outflow } }
